...
const Head = () => {
  ...
  return (
    <section
      id="hero"
      className="widescreen:section-min-height tallscreen:section-min-height section-min-height mb-12 flex scroll-mt-40 flex-col-reverse items-center justify-center gap-8 overflow-hidden bg-heroImg bg-cover p-6 sm:flex-row"
    >
      <article className="sm:w-1/2" ref={(el) => (intro = el)}>
        ...
        <h2 className="max-w-md text-center text-6xl font-bold text-white sm:text-left sm:text-5xl">
          Klub studenata Istre "Mate Balota"
        </h2>
        <p className="mt-4 max-w-md text-center text-base text-white sm:text-left">
